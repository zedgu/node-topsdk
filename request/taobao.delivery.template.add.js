...
request.prototype.setValuation = function(valuation) {
	this.valuation = valuation;
	this.apiParas["valuation"] = valuation;
};

request.prototype.getValuation = function() {
...
request.prototype.check = function(topApiCheck) {
	...
	topApiCheck.checkNotNull(this.assumer,"assumer");
	...
	topApiCheck.checkNotNull(this.valuation,"valuation");
};
