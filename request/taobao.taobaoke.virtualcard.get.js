...
request.prototype.getCardType = function() {
...
request.prototype.setGameName = function(gameName) {
	this.gameName = gameName;
	this.apiParas["game_name"] = gameName;
};

request.prototype.getGameName = function() {
...
request.prototype.setOperator = function(operator) {
	this.operator = operator;
	this.apiParas["operator"] = operator;
};

request.prototype.getOperator = function() {
...
request.prototype.check = function(topApiCheck) {
	...
	topApiCheck.checkNotNull(this.bizType,"bizType");
	topApiCheck.checkNotNull(this.cardType,"cardType");
