...
request.prototype.setCompanyCodes = function(companyCodes) {
	this.companyCodes = companyCodes;
	this.apiParas["company_codes"] = companyCodes;
};

request.prototype.getCompanyCodes = function() {
	return this.companyCodes;
};

request.prototype.setMemos = function(memos) {
	this.memos = memos;
	this.apiParas["memos"] = memos;
};

request.prototype.getMemos = function() {
	return this.memos;
};

request.prototype.setOrderTypes = function(orderTypes) {
	this.orderTypes = orderTypes;
	this.apiParas["order_types"] = orderTypes;
};

request.prototype.getOrderTypes = function() {
	return this.orderTypes;
};

request.prototype.setOutSids = function(outSids) {
	this.outSids = outSids;
	this.apiParas["out_sids"] = outSids;
};

request.prototype.getOutSids = function() {
	return this.outSids;
};

request.prototype.setSellerAddress = function(sellerAddress) {
	this.sellerAddress = sellerAddress;
	this.apiParas["seller_address"] = sellerAddress;
};

request.prototype.getSellerAddress = function() {
	return this.sellerAddress;
};

request.prototype.setSellerAreaId = function(sellerAreaId) {
	this.sellerAreaId = sellerAreaId;
	this.apiParas["seller_area_id"] = sellerAreaId;
};

request.prototype.getSellerAreaId = function() {
	return this.sellerAreaId;
};

request.prototype.setSellerMobile = function(sellerMobile) {
	this.sellerMobile = sellerMobile;
	this.apiParas["seller_mobile"] = sellerMobile;
};

request.prototype.getSellerMobile = function() {
	return this.sellerMobile;
};

request.prototype.setSellerName = function(sellerName) {
	this.sellerName = sellerName;
	this.apiParas["seller_name"] = sellerName;
};

request.prototype.getSellerName = function() {
	return this.sellerName;
};

request.prototype.setSellerPhone = function(sellerPhone) {
	this.sellerPhone = sellerPhone;
	this.apiParas["seller_phone"] = sellerPhone;
};

request.prototype.getSellerPhone = function() {
	return this.sellerPhone;
};

request.prototype.setSellerZip = function(sellerZip) {
	this.sellerZip = sellerZip;
	this.apiParas["seller_zip"] = sellerZip;
};

request.prototype.getSellerZip = function() {
...
request.prototype.check = function(topApiCheck) {
	...
	topApiCheck.checkNotNull(this.tids,"tids");
};
