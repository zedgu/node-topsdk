...
request.prototype.setCancelId = function(cancelId) {
	this.cancelId = cancelId;
	this.apiParas["cancel_id"] = cancelId;
};

request.prototype.getCancelId = function() {
	return this.cancelId;
};

request.prototype.setCompanyCode = function(companyCode) {
	this.companyCode = companyCode;
	this.apiParas["company_code"] = companyCode;
};

request.prototype.getCompanyCode = function() {
...
request.prototype.setSenderId = function(senderId) {
	this.senderId = senderId;
	this.apiParas["sender_id"] = senderId;
};

request.prototype.getSenderId = function() {
...
request.prototype.check = function(topApiCheck) {
	...
	topApiCheck.checkNotNull(this.companyCode,"companyCode");
