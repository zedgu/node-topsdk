...
request.prototype.setRid = function(rid) {
	this.rid = rid;
	this.apiParas["rid"] = rid;
};

request.prototype.getRid = function() {
	return this.rid;
};
...
request.prototype.check = function(topApiCheck) {
	...
	topApiCheck.checkNotNull(this.bedType,"bedType");
	topApiCheck.checkMaxLength(this.bedType,1,"bedType");
	topApiCheck.checkNotNull(this.breakfast,"breakfast");
	...
	topApiCheck.checkNotNull(this.guide,"guide");
	topApiCheck.checkMaxLength(this.guide,8000,"guide");
	topApiCheck.checkNotNull(this.hid,"hid");
	topApiCheck.checkNotNull(this.paymentType,"paymentType");
	topApiCheck.checkMaxLength(this.paymentType,1,"paymentType");
	topApiCheck.checkNotNull(this.rid,"rid");
	topApiCheck.checkNotNull(this.roomQuotas,"roomQuotas");
