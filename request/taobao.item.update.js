...
request.prototype.setIsReplaceSku = function(isReplaceSku) {
	this.isReplaceSku = isReplaceSku;
	this.apiParas["is_replace_sku"] = isReplaceSku;
};

request.prototype.getIsReplaceSku = function() {
