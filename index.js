...
winston.add(Graylog2, {
	...
	graylogHostname: 'api.taodatu.com'
});

var TopSDK = module.exports = function() {
		this.appkey = '12525293';
		this.secretkey = '9a96f5db026f9b24edc43f03386373a3';
		...
		this.signMethod = "md5";
		this.apiVersion = "2.0";
		this.sdkVersion = "top-sdk-node-20120306";
...
TopSDK.prototype.logError = function(error) {
	winston.error(['appkey:' + this.appkey, 'sdkVersion:' + this.sdkVersion, 'req:' + this.gatewayPath, 'error:' + error.stack].join('|||'));
	return error;
};
